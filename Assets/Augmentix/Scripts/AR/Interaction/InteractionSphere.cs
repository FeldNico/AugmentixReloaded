                ...
                switch (flag)
                {
                    case OOI.InteractionFlag.Text:
                    {
                        item = Instantiate(_interactionManager.TextPrefab,
                            _warpzoneManager.ActiveWarpzone.transform.position,
                            _warpzoneManager.ActiveWarpzone.transform.rotation * Quaternion.AngleAxis(180f, Vector3.up),
                            transform);
                    ...
                    case OOI.InteractionFlag.Video:
                    {
                        item = Instantiate(_interactionManager.VideoPrefab,
                            _warpzoneManager.ActiveWarpzone.transform.position,
                            _warpzoneManager.ActiveWarpzone.transform.rotation, transform);
